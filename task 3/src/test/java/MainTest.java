...
public class MainTest {
    ...
    @Test
    void testRobotsBuiltWithNoParts() {
    ...
    void testSingleDaySimulation() throws InterruptedException {
        ...
        Main.Factory factory = new Main.Factory(storage, days, dayLatch, nightLatch);
        Main.Faction world = new Main.Faction("World", storage, days, dayLatch, nightLatch);
        Main.Faction wednesday = new Main.Faction("Wednesday", storage, days, dayLatch, nightLatch);
